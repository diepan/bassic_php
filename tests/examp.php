...
class Motorcycles {
    ...
    public function nakedBike() {
        echo $this->name . ' ' . $this->kawasakiNakedBike();
    }
    private function kawasakiNakedBike(){
        return 'kawasaki ninja';
    }
}
class kawasakiMotorcycles extends Motorcycles {
    public function getMotor(){
        echo $this->getName() . ' z1000';
    }
}
$motor = new kawasakiMotorcycles; // khởi tạo đối tượng $motor từ class WoMan
$motor->setName('kawasaki');
$motor->getMotor();